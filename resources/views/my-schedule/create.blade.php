                    ...
                    <form action="{{ route('my-schedule.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-select id="service_id" init-hour="8" end-hour="17" :selected="old('service_id')" class="block mt-1 w-full" name="service_id">
                            ...
                            <div>
                                <x-label for="staff_user_id" :value="__('Elige quién te atenderá')" />
                                    ...
                                    <x-select id="staff_user_id" init-hour="8" end-hour="17" :selected-hour="old('staff_user_id')" class="block mt-1 w-full" name="staff_user_id">
